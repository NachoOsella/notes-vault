...
- vs [[20 - API - REST vs SOAP]]: REST es un estilo arquitectónico más ligero/flexible; SOAP es un protocolo más rígido basado en XML y contrato.
- vs [[15 - HTTP - Métodos de solicitud]]: REST se apoya en los verbos HTTP para modelar operaciones sobre recursos.
- vs [[11 - HTTP - Características clave]]: REST hereda de HTTP ideas como stateless y uso de headers/representaciones.
