...
- vs [[11 - HTTP - Características clave]]: este describe actores y capas (cliente/servidor/intermediarios); el otro describe reglas del protocolo (stateless, headers).
- vs [[04 - Cliente-Servidor - Componentes]]: HTTP es un sistema cliente-servidor concreto; el otro define el modelo general y sus piezas.
- vs [[10 - HTTP - Proxies]]: el proxy es un intermediario dentro del sistema; el sistema incluye muchos componentes (no solo proxies).
