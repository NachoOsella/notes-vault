...
- vs [[17 - API - Qué es una API]]: acá se clasifica por alcance (local/remota/web); el otro da la definición general de API.
- vs [[18 - API - Qué es un Servicio Web]]: una API web suele ser un servicio web cuando expone endpoints por red (HTTP/HTTPS).
- vs [[19 - API - Arquitectura RESTful (API REST)]]: REST es una forma típica de implementar una API web; no aplica a APIs locales.
