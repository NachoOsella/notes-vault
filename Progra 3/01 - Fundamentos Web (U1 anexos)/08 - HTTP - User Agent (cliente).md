...
- vs [[09 - HTTP - Servidor Web]]: el user agent inicia la comunicación (requests); el servidor espera y responde.
- vs [[05 - Cliente-Servidor - Clientes y servidores]]: el user agent es el cliente en HTTP; el modelo cliente-servidor es el concepto general.
- vs [[10 - HTTP - Proxies]]: el user agent habla con el servidor directamente o a través de intermediarios (proxy), pero sigue iniciando requests.
