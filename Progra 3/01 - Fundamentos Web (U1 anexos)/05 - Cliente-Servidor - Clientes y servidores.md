...
- vs [[04 - Cliente-Servidor - Componentes]]: acá se explican roles; el otro lista todas las piezas (red, protocolo, servicio, BD, etc.).
- vs [[08 - HTTP - User Agent (cliente)]]: el user agent es un tipo de cliente en HTTP (navegador/bot) que inicia requests.
- vs [[09 - HTTP - Servidor Web]]: el servidor web es el servidor en el contexto de HTTP: espera requests y responde.
