...
- vs [[HTTP - Sistemas basados en HTTP]]: el proxy es un componente opcional del sistema; cliente y servidor son obligatorios.
- vs [[HTTP - Servidor Web]]: el proxy intermedia/optimiza; el servidor es el origen que genera la respuesta.
- vs [[HTTP - User Agent (cliente)]]: el user agent pide recursos; el proxy puede filtrar/cachear esas peticiones sin cambiar al cliente.
