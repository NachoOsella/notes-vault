...
- vs [[18 - API - Qué es un Servicio Web]]: REST y SOAP son dos enfoques comunes para implementar servicios web.
- vs [[15 - HTTP - Métodos de solicitud]]: REST explota verbos HTTP y semántica de recursos; SOAP no depende del modelo de verbos HTTP.
