...
- vs [[HTTP - Request]] / [[HTTP - Response]]: el flujo es el proceso completo; request/response son las unidades de mensaje que viajan dentro.
- vs [[HTTP - Características clave]]: flujo describe pasos; características describe propiedades del protocolo (stateless, extensible).
