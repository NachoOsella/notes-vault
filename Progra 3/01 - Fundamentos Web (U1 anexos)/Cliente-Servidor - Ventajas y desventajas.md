...
- vs [[Cliente-Servidor - Características y componentes]]: acá se evalúan tradeoffs (pros/contras); el otro describe cómo funciona el modelo.
- vs [[Cliente-Servidor - Clientes y servidores]]: acá se analizan beneficios/costos; el otro define responsabilidades de roles.
- vs [[HTTP - Sistemas basados en HTTP]]: HTTP es un ejemplo de cliente-servidor; sus ventajas (caché, capas) y costos (latencia) se ven en la práctica.
