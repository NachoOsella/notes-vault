...
- vs [[HTTP - Request]]: el método es una parte del request; el request completo incluye URL, headers y body.
- vs [[HTTP - Códigos de estado]]: el método indica la intención del cliente; el código de estado indica el resultado que devolvió el servidor.
- vs [[API - Arquitectura RESTful (API REST)]]: REST usa los métodos HTTP como acciones sobre recursos (GET/POST/PUT/PATCH/DELETE).
