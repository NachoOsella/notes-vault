...
- vs [[05 - Web - Sitios estáticos]]: el servidor puede servir contenido estático (archivos fijos) o dinámico (generado en tiempo real)
- vs [[06 - Web - Sitios dinámicos]]: los sitios dinámicos requieren que el servidor ejecute código backend
