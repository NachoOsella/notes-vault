...
- vs [[Web - Sitios dinámicos]]: los sitios dinámicos generan contenido en tiempo real según el usuario o contexto; los estáticos sirven siempre lo mismo
- vs [[Web - Qué es un servidor web]]: el servidor solo entrega archivos, no ejecuta lógica
