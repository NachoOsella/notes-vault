...
- vs [[Web - Sitios estáticos]]: los estáticos sirven archivos fijos; los dinámicos generan contenido en cada petición
- vs [[Web - Qué es un servidor web]]: en sitios dinámicos, el servidor no solo sirve archivos sino que ejecuta código
