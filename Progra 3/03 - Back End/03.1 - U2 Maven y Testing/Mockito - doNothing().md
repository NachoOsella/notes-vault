...
- vs [[Mockito - thenReturn()]]: `doNothing` aplica a métodos `void`; `thenReturn` aplica a métodos con retorno.
- vs [[Mockito - thenThrow()]]: `doNothing` simula "no pasa nada"; `doThrow` simula error en métodos void.
