...
- vs [[Testing - Fundamentos]]: introducción = panorama general y por qué testear; fundamentos = conceptos y principios que sostienen la práctica.
- vs [[Testing - Tests unitarios]]: intro es general; unit tests son el tipo de test más "chico" y rápido.
