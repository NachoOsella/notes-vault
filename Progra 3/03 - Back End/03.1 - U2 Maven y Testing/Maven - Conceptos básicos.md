...
- vs [[Maven - Archivos de configuración]]: Maven como herramienta vs los archivos donde se describe el proyecto/entorno (p. ej. `pom.xml`).
- vs [[Maven - Gestión de dependencias]]: idea general de dependencias vs cómo se resuelven versiones, scopes y repos.
