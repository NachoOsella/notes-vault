...
- vs [[Mockito - mock() y @Mock]]: `@Mock` crea dependencias falsas; `@InjectMocks` crea el objeto bajo test e inyecta esas dependencias.
- vs [[Reflection - Concepto]]: la inyección de Mockito usa reflection internamente para acceder a constructores/campos/setters.
