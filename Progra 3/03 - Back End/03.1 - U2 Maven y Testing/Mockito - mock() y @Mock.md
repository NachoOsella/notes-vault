...
- vs [[Mockito - spy() y @Spy]]: mock reemplaza todo el comportamiento (métodos devuelven null/0/false por default); spy envuelve un objeto real y podés stubear solo partes.
- vs [[Mockito - @InjectMocks]]: `@Mock` crea dependencias falsas; `@InjectMocks` crea el objeto bajo test e inyecta esos mocks automáticamente.
