...
- vs [[Mockito - when()]]: `when/then...` define comportamiento del mock **antes**; `verify` valida llamadas **después**.
- vs [[Testing - Tests unitarios]]: verify es útil en unit tests orientados a interacción (verificar colaboradores) más que a estado (verificar resultado).
