...
- vs [[23 - ReflectionSupport (JUnit)]]: reflection es el concepto general de Java; ReflectionSupport es una utilidad de JUnit que simplifica su uso en tests.
- vs [[16 - Mockito - @InjectMocks]]: Mockito usa reflection internamente para inyectar mocks en campos/constructores automáticamente.
