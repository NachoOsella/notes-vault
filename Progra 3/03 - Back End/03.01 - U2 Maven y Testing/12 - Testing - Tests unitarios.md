...
- vs [[11 - Testing - Fundamentos]]: unit tests implementan los principios de testing; fundamentos explica el marco mental general.
- vs [[14 - Mockito - mock() y @Mock]]: unit tests suelen usar mocks para aislar dependencias externas.
