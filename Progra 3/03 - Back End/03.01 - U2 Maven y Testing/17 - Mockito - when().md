...
- vs [[18 - Mockito - thenReturn()]]: `when(...)` arranca el stubbing; `thenReturn(...)` define el valor devuelto.
- vs [[21 - Mockito - verify()]]: stubbing (`when`) define comportamiento **antes** de ejecutar; verify valida interacciones **después**.
