...
- vs [[17 - Mockito - when()]]: `when(...).thenReturn(...)` es el combo típico para stubear retornos.
- vs [[19 - Mockito - thenThrow()]]: `thenReturn` simula éxito/respuesta normal; `thenThrow` simula error/excepción.
