...
- vs [[10 - Testing - Introducción]]: fundamentos profundiza en conceptos (tipos, características, ciclo de vida); intro es más contextual.
- vs [[12 - Testing - Tests unitarios]]: fundamentos aplica a todo tipo de testing; unit tests son un caso concreto (aislado, rápido, determinista).
