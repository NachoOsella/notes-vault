...
- vs [[12 - Testing - Tests unitarios]]: writing tests se enfoca en el "cómo" (estructura, anotaciones); unit tests define el "qué" (concepto general).
- vs [[17 - Mockito - when()]]: writing tests define el flujo del test; `when(...).then...` sirve para stubear dependencias dentro del test.
