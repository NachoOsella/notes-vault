...
- vs [[07 - Maven - Gestión de dependencias]]: plugins = tareas del build; dependencias = librerías que se linkean/usan en código.
- vs [[05 - Maven - Ciclo de vida]]: plugins se atan a fases (compile/test/package) para automatizar el pipeline.
