...
- vs [[22 - Reflection - Concepto]]: ReflectionSupport es una utilidad que simplifica reflection; el concepto es el mecanismo base de Java.
- vs [[13 - Testing - Writing tests]]: ReflectionSupport aparece para casos especiales (métodos privados); writing tests cubre el caso normal con métodos públicos.
