...
- vs [[04 - Maven - Conceptos básicos]]: archetype es “plantilla de proyecto”; Maven es el sistema de build/deps.
- vs [[06 - Maven - Archivos de configuración]]: el archetype genera estructura inicial + `pom.xml` base.
